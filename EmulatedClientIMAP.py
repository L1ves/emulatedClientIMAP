...
# Base code source: https://twistedmatrix.com/documents/current/_downloads/dfd56764a8b92a63602310893b262eb7/imap4client.py
...
if __name__ == '__main__':
    ...
    main(hostname,port,username,password)
